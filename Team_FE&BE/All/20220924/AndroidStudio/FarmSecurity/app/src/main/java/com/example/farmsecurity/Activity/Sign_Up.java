...
public class Sign_Up extends AppCompatActivity {
            ...
            if(user_pw.isEmpty()){
                ...
                if(user_pw_re.isEmpty()){
                    ...
                    if(user_name.isEmpty()){
                        Toast chToast = Toast.makeText(getApplicationContext(), "이름을 입력해주세요.",Toast.LENGTH_LONG);
                        chToast.show();
                    }
                    else {
    ...
    public void SignUpProcess() {
        ...
        Log.d("FCM Log", "Refreshed token: "+user_token);
        AlertDialog.Builder Dialog = new AlertDialog.Builder(this, android.R.style.Theme_DeviceDefault_Light_Dialog);

        SignUpRequest signUpRequest = new SignUpRequest(user_id, user_pw, user_name, user_address, user_phone, user_token);
    ...
    public void RuleId() {
        ...
        if(user_id.length()>=5&&user_id.length()<=12){
            ...
            Toast.makeText(getApplicationContext(), "아이디는 5~12자까지 사용할 수 있습니다.", Toast.LENGTH_SHORT).show();
            /*
    ...
    public void RulePw() {
        ...
        if(user_pw.length()>=8){
            if(user_pw.contains(" ")){
                Toast.makeText(getApplicationContext(), "비밀번호에 공백을 사용할 수 없습니다.", Toast.LENGTH_SHORT).show();
                /*
    ...
    public void RuleName() {
        ...
        if(user_name.contains(" ")){
            Toast.makeText(getApplicationContext(), "이름에 공백을 사용할 수 없습니다.", Toast.LENGTH_SHORT).show();
            /*
            ...
            for(i=0;i<user_name.length();i++){
                if(!String.valueOf(user_name.charAt(i)).matches("^[a-zA-Zㄱ-ㅎ가-힣]*$")){
                    Toast.makeText(getApplicationContext(), "이름에 특수문자를 사용할 수 없습니다.", Toast.LENGTH_SHORT).show();
                    /*
    ...
    public void RuleAddress() {
        ...
        for(i=0;i<user_address.length();i++){
            if(!String.valueOf(user_address.charAt(i)).matches("^[a-zA-Zㄱ-ㅎ가-힣]*$")){
                Toast.makeText(getApplicationContext(), "주소에 특수문자를 사용할 수 없습니다.", Toast.LENGTH_SHORT).show();
                /*
    ...
    public void RulePhone() {
        ...
        if(user_phone.length()==11){
            ...
            Toast.makeText(getApplicationContext(), "휴대폰 길이는 11자리입니다.", Toast.LENGTH_SHORT).show();
            /*
